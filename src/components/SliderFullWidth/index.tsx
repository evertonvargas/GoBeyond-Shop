...
export function SliderFullWidth() {
  ...
  return (
    <section className={styles.slide}>
      <button className={styles.prev} onClick={handlePrevSlide}><MdKeyboardArrowLeft size={50}/></button>
      ...
      <button className={styles.next} onClick={handleNextSlide}><MdKeyboardArrowRight size={50}/></button>
    </section>   
  );
}
